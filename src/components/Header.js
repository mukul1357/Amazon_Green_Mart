        ...
        {mediaWidth > 840 && (
            <div class="flex header__search">
              <div class="relative w-full">
                <input type="text" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 header__searchInput" placeholder="Search Amazon"/>
                    <div className="absolute top-0 right-0 p-2.5 text-sm font-medium h-full rounded-r-lg border focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 header__searchIcon header__searchIcon"><AiOutlineSearch /></div>
              </div>
            </div>
...
{mediaWidth > 840 && (
            <Link to="/sell">
              <div className="header__option">
                <span className="header__optionTwo" style={{fontSize: "1.2em", fontWeight: "500"}}>Sell</span>
              </div>
            </Link>
          )}
          ...
          <Link to="/checkout">
            <div className="header__optionBasket">
              ...
              {mediaWidth > 840 && <span className="header__optionTwo">Cart</span>}
            </div>
          </Link>
          {mediaWidth > 840 && user && (
            <div className="header__option1" id="coinIcon">
              <img src={coinIcon} alt="" style={{width: "74%"}}/>
              {mediaWidth > 840 && <span className="points" style={{ fontWeight: "bold" }}>{parseInt(greenPoints)}</span>}
            </div>
          )}
        </nav>
      </div>
